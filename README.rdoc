...
The +afterComplete+ optione is very interesting for nested links, i.e. in navigations. So you can wait the effect to finish before redirecting to another page.
